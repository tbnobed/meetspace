...
export async function seedDatabase() {
  ...
  const bookingsData = [
    ...
    },
    {
      ...
      endTime: makeTime(11, 0),
      meetingType: "teams",
      attendees: ["john.doe@company.com", "mike.wilson@company.com", "sarah.johnson@company.com"],
      isRecurring: false,
    },
    {
      ...
      description: "New product demo for Acme Corp",
      startTime: makeTime(13, 0),
      endTime: makeTime(14, 30),
      meetingType: "zoom",
      attendees: ["jane.smith@company.com", "client@acme.com"],
      isRecurring: false,
    },
    {
      ...
      meetingType: "teams",
      attendees: ["mike.wilson@company.com", "john.doe@company.com"],
      isRecurring: false,
    },
    {
      roomId: createdRooms[14].id,
      userId: sjohnson.id,
      title: "HR Town Hall",
    ...
    },
    {
      ...
      endTime: makeTime(16, 0),
      meetingType: "none",
      attendees: ["admin@meetspace.io", "john.doe@company.com", "jane.smith@company.com", "mike.wilson@company.com"],
      isRecurring: false,
    },
  ];
