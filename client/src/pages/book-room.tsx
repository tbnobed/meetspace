  ...
  const createBooking = useMutation({
    mutationFn: async (values: BookingFormValues) => {
      ...
      const body: Record<string, any> = {
        ...
        meetingLink: values.meetingType !== "none" && values.meetingType !== "teams" && values.meetingLink ? values.meetingLink : undefined,
                ...
                <CardContent>
                  ...
                  {form.watch("meetingType") === "teams" && (
                    <p className="text-xs text-muted-foreground mt-4">
                      A Teams meeting link will be automatically generated by the room.
                    </p>
                  )}
